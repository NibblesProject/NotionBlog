...
const BLOG = {
  ...
  COMMENT_WALINE_SERVER_URL: process.env.NEXT_PUBLIC_WALINE_SERVER_URL || 'https://nibblesblog-waline.deta.dev', // Waline 评论 @see https://waline.js.org/guide/get-started.html
